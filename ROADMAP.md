...
- Add `packages/schema`
- Add Zod schemas for externally supplied configuration
- Add semantic validation for cross-references and invariants
- Add `packages/domain`
- Add Vitest
- Add ESLint/type-check/build scripts at the workspace root
...
- Snapshots
- Replay
- Time controls: pause, resume, speed, jump via snapshot/replay
